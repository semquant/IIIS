...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul 13 16:24:37 2017

@author: Zizou
"""

# Divide MNIST data to construct CNNs
...
accu = []
prob = []
data.divide(num = N_model)

# Train N models using divided data
for i in range(N_model):
    print("the {0}th part data is training on CNN".format(i+1))
    # Launch the graph
    with tf.Session() as sess:
        ...
        while step * batch_size < training_iters:
            batch_x, batch_y = data.divde_next_batch( \
                batch_size = batch_size, divrank = i+1)
