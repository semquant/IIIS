...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul 11 21:08:41 2017

@author: Zizou
"""
# Construct MNIST CNN Network Using Bootstrap method
...
# Train N models using bootstrapped data
for i in range(N_model):
    data.resample()
    print("the {0}th time bootstrap is finished".format(i+1))
    # Launch the graph
    with tf.Session() as sess:
        sess.run(init)
        step = 1
        print("the {0}th CNN is training".format(i+1))
